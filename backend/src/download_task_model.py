...
class download_task(BaseModel):
    ...
    def validate_quality(cls, v):
        acceptable_qualities = ["audio_only", "160p", "160p30", "worst", "360p", "360p30", "480p", "480p30", "720p", "720p60", "1080p60", "best"]
        if v not in acceptable_qualities:
            raise ValueError('Invalid quality parameter. Acceptable values are: audio_only, 160p, 160p30, worst, 360p, 360p30, 480p, 480p30 720p, 720p60, 1080p60, best')
        return v
